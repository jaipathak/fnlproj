...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="css/theme-animate.css">
                <link rel="stylesheet" type="ttext/css" media="all" href="css/centre.css">
		...
		<div class="wide_layout bg_light">
			...
			<section class="page_title translucent_bg_color_scheme image_fixed image_bg_14 t_align_c relative wrapper">
                            <div class="container" style="margin-top:100px; ">
                                <h1 class="color_light fw_light m_bottom_5" style="margin-top: -100px">Contact Us</h1>
									...
									<ul class="col-lg-6 col-md-6 col-sm-6 vr_list_type_5">
										...
										<li>
											...
											<ul>
												...
												<li>
                                                                                                    <button class="button_type_5 color_blue transparent r_corners fs_medium tr_all m_right_10 m_sm_bottom_10" onclick="box;">Submit</button>
												</li>
											</ul>
										</form>
									</div>
