		...
		<div class="wide_layout bg_light">
			...
			<section class="page_title translucent_bg_color_scheme image_fixed image_bg_14 t_align_c relative wrapper">
                            <div class="container" style="margin-top:100px; ">
                                <h1 class="color_light fw_light m_bottom_5" style="margin-top: -100px">Add New Blog</h1>
						...
						<div class="row">
                                             <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_sm_bottom_30" style="margin-left: 50px;" >
                                                  ...
                                                  <%
                                                            ...
                                                            <h5 class="color_dark fw_light m_bottom_23"><b style="font-size: 22px;color: #7f0000">Enter details</b></h5>
                                                            <form  class="no_captcha" action="addblog" method="post" >
											<ul>
                                                                                            <li class="m_bottom_10">
                                                                                                <input type="text" required name="title" placeholder="Enter Tittle" class="w_full r_corners fw_light bg_light">
												</li>
												<li class="m_bottom_10">
													<input type="text" required name="technology" placeholder="Enter Technology" class="w_full r_corners fw_light bg_light">
												</li>
                                                                                                <li class="m_bottom_20" style="color: #7f0000;">
													<textarea class="w_full d_block r_corners fw_light height_3" name="description" placeholder="Enter Description"></textarea>
												</li>
												<li>
