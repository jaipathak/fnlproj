	...
	<body class="sticky_menu">
		...
		<div class="wide_layout bg_light">
											...
											<li class="container3d relative f_xs_none m_xs_bottom_5">
												...
												<ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none">
													...
													<li>
                                                                                        ...
                                                                                        <li class="container3d relative f_xs_none m_xs_bottom_5">
												<a class="color_dark fs_large relative r_xs_corners" href="pages_about.html"><b style="font-size: 20px;">Plans</b>
													<i class="icon-angle-down d_inline_m"></i>
												</a>
												<ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none">
			...
			<section class="relative w_full m_bottom_15">
				<div class="r_slider">
                                    <img src="Pics/Google Analytic.jpg" style=" width: 1160px;  height: 540px;">
				</div>
                            <div class="tag" style="margin-left: 94px;">
                              ...
                              <ul>
                                       <li style="margin-top: -560px"> <br>
                                           <h2><b>Search Engine Management(SEM) Service</b></h2><br>
                                           
                            <p>Search Engine Management is the process of managing all aspects of the paid, free, shopping, and local search engine<br>
                               results and listing along with managing other areas of exposure and services offered by today's leading search engines.</p>

                                    </li>
                            	<br><br><li>

                                   <h3 style=""><b>How We Can Help</b></h3><br><

                                   <p>Prime Concepts can work with you to develop a simple social media marketing plan designed specifically for your business.<br>
                                       We can help you use social media and your blog to:<br><br>

                                    1) Monitor your brand.<br>
                                    2) Get top search engine rankings.<br>
                                    3) Generate leads.<br>
                                    4) Provide customer service.<br>
                                    5) Do damage control.<br>
                                    6) Build inbound marketing.<br>
                                    7) Connect with new prospects.<br>
                                    8) Engage your customer base.<br>
                                    9) Generate sales.</p>
                            </li>
                               ...
                               <br> <br><br><li>
                                   <h3>SMM Services</h3>
                                <br><br>
                                <p><strong>Facebook, Twitter, LinkedIn, YouTube, Google+, Pinterest and Blogs</strong>
                                    <br>
                                1. Profile setup<br>
                                2.Profile optimization to get you found<br>
                                3. Company branded pages<br>
                                4. Custom, branded social media backgrounds and graphics<br>
                                5. Social media networking daily, weekly and monthly plans<br>
                                6. Blog post and YouTube video Search Engine Optimization<br>
                                7. Social media share button integration<br>
                                8. Social media icon integration<br>
                                                                </p>
                            	</li>
                                <br><br>
